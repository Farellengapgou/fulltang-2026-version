...
import { UserProfileModal } from "../../../GlobalComponents/UserProfileModal.jsx"; // <-- Ajouté

export function DoctorNavBar({
  messageCount,
  messagePath = "/doctor/messages",
  title = "Doctor",
}) {
    ...
    <>
      <div className="border-b-2 m-3 border-b-gray-300">
        <div className="w-full h-[70px] flex justify-between">
          <h1 className="ml-3 text-4xl text-secondary mt-3.5 font-bold">{title}</h1>

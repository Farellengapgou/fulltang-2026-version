                ...
                <div className="mb-8 space-y-4">
                    <div className="flex flex-wrap gap-4">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-md hover:bg-primary-start duration-300 transition-all  hover:text-white ${filter === "Completed" ? "bg-primary-end text-white font-bold " : "bg-gray-100 text-gray-800 hover:bg-gray-200"
                                } transition-colors`}
                        >
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <div className="flex items-center">
                            ...
                            <DatePicker
                                ...
                                className="px-4 py-2 border border-gray-300 rounded-md focus:ring-0 focus:outline-none focus:border-2 focus:border-primary-end h-10 w-full"
                            />
                        </div>
                    </div>
                </div>

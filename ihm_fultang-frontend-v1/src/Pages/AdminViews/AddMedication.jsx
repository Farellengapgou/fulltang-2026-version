...
export function AddMedication() {
  ...
  async function handleSubmit(e) {
    console.log("DEBUG - All medicationData:", medicationData);
    e.preventDefault();
    setIsLoading(true);
        ...
        <div className="flex m-5">
          <div className="w-1/2 mr-6 flex flex-col items-center justify-center">
            ...
            <p className="text-justify text-secondary font-normal text-md mb-5">
              Please complete all fields below to add a new product to Fultang
              Clinic.
            </p>
            <img
              src={medicationImage}
          ...
          <div className="w-1/2 p-6 mt-8 flex items-center justify-center">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className={applyLabelStyle()}>Name</label>
                  <input
                    type="text"
                    name="name"
                ...
                <div>
                  <label className={applyLabelStyle()}>Generic name</label>
                  <input
                    type="text"
                    name="generic_name"
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className={applyLabelStyle()}>Category</label>
                ...
                <div>
                  <label className={applyLabelStyle()}>Brand</label>
                  <input
                    type="text"
                    name="brand"
              ...
              <div className="grid grid-cols-3 gap-2">
                <div>
                  <label className={applyLabelStyle()}>Price (FCFA)</label>
                  <input
                    type="number"
                    name="price"
                ...
                <div>
                  <label className={applyLabelStyle()}>Stock</label>
                  <input
                    type="number"
                    name="current_stock"
                ...
                <div>
                  <label className={applyLabelStyle()}>Expiry date</label>
                  <DatePicker
                    placeholder="Select expiry date"
                    value={
                      medicationData.expiry_date
                        ? dayjs(medicationData.expiry_date)
                        : null
                    }
              ...
              <div>
                <label className={applyLabelStyle()}>Description</label>
                <input
                  type="text"
                  name="description"

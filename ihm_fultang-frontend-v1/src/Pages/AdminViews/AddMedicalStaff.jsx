  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setErrorMessage("");
        setSuccessMessage(
          `The ${medicalStaffData.role === "Labtech" ? "Laboratory Assistant" : medicalStaffData.role + "" + " " + medicalStaffData.username + " "} created successfully`,
        );
      ...
      setSuccessMessage("");
      setErrorMessage(
        `Error when registering the ${medicalStaffData.role + " " + medicalStaffData.username} please retry !`,
      );
    ...
    <CustomDashboard linkList={adminNavLink} requiredRole={"Admin"}>
      ...
      <div className="flex m-5">
        <div className="w-1/2 mr-6 flex flex-col items-center justify-center">
          ...
          <p className="text-justify text-secondary font-normal text-md mb-5">
            Please complete all fields below to add a new medical staff member
            to Fultang Clinic.
          </p>
          <img
            src={joinOurStaffImage}
            alt={"image"}
        ...
        <div className="w-1/2 p-8 flex items-center justify-center">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className={applyLabelStyle()}>Firstname</label>
                <input
                  type="text"
                  name="first_name"
              ...
              <div>
                <label className={applyLabelStyle()}>Lastname</label>
                <input
                  type="text"
                  name="last_name"
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className={applyLabelStyle()}>Username</label>
                <input
                  type="text"
                  name="username"
              ...
              <div>
                <label className={applyLabelStyle()}>Password</label>
            ...
            <div className="grid grid-cols-3 gap-2">
              <div>
                <label className={applyLabelStyle()}>Birth Date</label>
                <DatePicker
                  placeholder="Select birth date"
                  value={
                    medicalStaffData.birthDate
                      ? dayjs(medicalStaffData.birthDate)
                      : null
                  }
              ...
              <div>
                <label className={applyLabelStyle()}>Gender</label>
                <select
                  name="gender"
              ...
              <div>
                <label className={applyLabelStyle()}>Address</label>
                <input
                  type="text"
                  name="address"
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className={applyLabelStyle()}>ID Card Number</label>
                <input
                  type="tel"
                  name="cniNumber"
              ...
              <div>
                <label className={applyLabelStyle()}>Phone Number</label>
                <PhoneInput
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className={applyLabelStyle()}>Email</label>
                <input
                  type="email"
                  name="email"
              ...
              <div>
                <label className={applyLabelStyle()}>Spécialisation</label>
                <select
                  name="role"
                ...
                >
                  <option value="NoRole">
                    Select the medical staff specialisation
                  </option>
                  ...
                  <option value="MaterialAccountant">
                    Material Accountant
                  </option>

  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setSuccessMessage(
          `The ${
            medicalStaffData.role === "Labtech"
              ? "Laboratory Assistant"
              : medicalStaffData.role +
                "" +
                " " +
                medicalStaffData.username +
                " "
      ...
      setErrorMessage(
        `Error when registering the ${
          medicalStaffData.role + " " + medicalStaffData.username
        } please retry !`
      );
    ...
    <CustomDashboard linkList={adminNavLink} requiredRole={"Admin"}>
      ...
      <div className="flex m-5">
        <div className="w-1/2 mr-6 flex flex-col items-center justify-center">
          ...
          <p className="text-justify italic text-red-500 font-semibold text-md mb-5">
            Please complete all fields below to add a new medical staff member
            to Fultang Clinic. Make sure the information entered is accurate as
            it will be used to create the staff member's official profile.
          </p>

        ...
        <LaboratoryDashBoard linkList={laboratoryNavLink} requiredRole={"Labtech"}>
            ...
            <div className="mt-5 flex flex-col relative">
                ...
                <div className="flex justify-between mb-5">
                    <p className="font-bold text-xl mt-2 ml-5">List Of Patient ({filteredPatients.length})</p>
                        ...
                        {filteredPatients.map((patient, index) => (
                            ...
                            >
                                <td className="px-6 py-5 rounded-l-xl bg-gray-100 border-l-4 border-primary-start">
                                    <div className="w-full flex items-center justify-center">{index + 1}</div>
                                </td>
                                <td className="px-6 py-5 bg-gray-100">
                                    <div className="w-full flex items-center justify-center">{patient.firstName}</div>
                                </td>
                                <td className="px-6 py-5 bg-gray-100">
                                    <div className="w-full flex items-center justify-center">{patient.lastName}</div>
                                </td>
                                <td className="px-6 py-5 bg-gray-100">
                                    <div className="w-full flex items-center justify-center">{patient.gender}</div>
                                </td>
                                <td className="px-6 py-5 bg-gray-100">
                                    <div className="w-full flex items-center justify-center">{patient.address}</div>
                                </td>
                                <td className="px-6 py-5 bg-gray-100">
                                    <div className="w-full items-center justify-center flex gap-6">
                                        <Tooltip placement={"right"} title={"View Medical Folder"}>
                                            <button
                                                    onClick={() => {
                                                        navigate(`${AppRoutesPaths.doctorPatientMedicalFolderPage.replace(":id", patient.id)}`);
                                                    }}
                    ...
                    {patients.length === 0 && (
                        <div className="p-8 mt-24 flex items-center justify-center">
                            <div className="flex flex-col">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800 mb-2 mx-auto">No Patient</h2>
                                <p className="text-gray-600 mb-4 mx-auto text-center">
                                    There are no patients with exam requests yet. 
                        ...
                        <div className="fixed w-full justify-center bottom-0 flex mt-6 mb-4 left-20">
                            <div className="flex gap-4">
                                ...
                                <p className="text-secondary text-2xl font-bold mt-4">
                                    {numberOfPatients === 0 ? "0/0" : `${actualPageNumber}/${calculateNumberOfSlide()}`}
                                </p>

...
export function LaboratoryExamList() {
    ...
    const filteredExams = examRequestList.filter((exam) => {
        ...
        const matchesDate =
            !dateFilter ||
            new Date(exam.requestDate || "").toISOString().split("T")[0] === dateFilter;
                                            ...
                                            <div className="w-full flex justify-center items-center">
                                                ...
                                                <div>
                                                    <div className="text-sm text-center text-gray-900">
                                                        {exam.requestDate ? formatDateOnly(exam.requestDate) : "N/A"}
                                                    </div>
                                                    <div className="text-sm text-center text-gray-500">
                                                        {exam.requestDate ? formatDateToTime(exam.requestDate) : "N/A"}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>

...
export function MaterialDashboard() {
    ...
    const COLORS = ["#0D9488", "#3B82F6", "#8B5CF6", "#F59E0B", "#EF4444", "#EC4899", "#10B981", "#F97316", "#6366F1"];
    ...
    const stockByWarehouse = stats?.stock_by_warehouse?.map(w => ({
        name: w.name,
        value: w.value
    })) || [];

    const stockByCategory = stats?.stock_by_category?.map(c => ({
        name: c.name,
        value: c.value
    })) || [];
            ...
            <div className="mx-auto p-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h3 className="text-lg font-bold text-gray-800 mb-6">Répartition par Catégorie</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="mt-4 space-y-2">
                            {stockByWarehouse.map((w, idx) => (
                                <div key={idx} className="flex items-center justify-between text-xs">
                                    <div className="flex items-center">
                                        <div className="h-3 w-3 rounded-full mr-2" style={{ backgroundColor: COLORS[(idx + 2) % COLORS.length] }}></div>

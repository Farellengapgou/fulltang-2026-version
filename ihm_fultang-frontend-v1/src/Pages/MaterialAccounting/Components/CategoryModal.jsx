    ...
    useEffect(() => {
        if (editingCategory) {
            setFormData({
                ...
                default_stock_account: editingCategory.default_stock_account?.id || editingCategory.default_stock_account || "",
                default_expense_account: editingCategory.default_expense_account?.id || editingCategory.default_expense_account || "",

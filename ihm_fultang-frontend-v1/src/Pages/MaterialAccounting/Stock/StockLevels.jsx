                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                        ...
                        <p className="text-2xl font-bold text-gray-800">
                            {formatCurrency(stockLevels.reduce((sum, s) => sum + s.stock_value, 0))}
                        </p>
                    </div>
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                                ...
                                {filteredStock.map((stock) => (
                                    <tr key={stock.id}>
                                        <td className="px-6 py-4 bg-gray-50 border-l-4 border-primary-end rounded-l-xl">
                                            <div>
                                                <p className="font-bold text-gray-900">{stock.article.code}</p>
                                                <p className="text-sm text-gray-600">{stock.article.name}</p>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 bg-gray-50">
                                            <p className="text-sm text-gray-800">{stock.warehouse.name}</p>
                                        </td>

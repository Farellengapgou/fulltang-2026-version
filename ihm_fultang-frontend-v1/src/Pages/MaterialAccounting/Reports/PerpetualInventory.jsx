...
import { getPerpetualInventory, getWarehouses } from "../../../Utils/api/materialAccounting.js";
...
export function PerpetualInventory() {
    ...
    const loadData = async () => {
        try {
            setIsLoading(true);
            const data = await getPerpetualInventory(selectedDate, selectedWarehouseId);

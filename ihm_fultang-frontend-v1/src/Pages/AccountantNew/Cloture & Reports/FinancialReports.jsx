...
import { FileText, Calendar, Printer, Play, Hash, ArrowDownRight, ArrowUpRight, Calculator, Landmark } from "lucide-react";
        ...
        >
            ...
            <div className="ft-page">
                <div className="flex justify-between items-end mb-10">
                    <div>
                        <h1 className="text-3xl font-black text-secondary tracking-tight uppercase">Etats Financiers</h1>
                        <p className="text-gray-400 text-sm font-medium mt-1 uppercase tracking-widest italic">Production des documents de synthèse comptable</p>
                    </div>
                    <div className="flex gap-3">
                        <button
                            onClick={() => window.print()}
                            className="ft-btn ft-btn-md ft-btn-outline gap-2"
                        >
                ...
                <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-50 mb-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="space-y-1">
                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Nature du document</label>
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="income_statement">Compte de Résultat (SIG)</option>
                ...
                {data && (
                    <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-50">
                        {reportType === "balance_sheet" && (
                            <div className="space-y-12">
                                <div className="text-center border-b pb-8">
                                    <h2 className="text-2xl font-black text-secondary uppercase tracking-tight">BILAN ACTIF / PASSIF</h2>
                                    <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] mt-2">Situation au {endDate || new Date().toLocaleDateString()}</p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-3 mb-6 border-l-4 border-emerald-500 pl-4">
                                            ...
                                            <h3 className="text-lg font-black text-gray-800 uppercase">ACTIF</h3>
                                        </div>
                                        <table className="w-full">
                                            <tbody>
                                                {data.assets?.map((a) => (
                                                    <tr key={a.id} className="border-b border-gray-50 group hover:bg-gray-50 transition-colors">
                                                        <td className="py-4">
                                                            <div className="text-xs font-black text-secondary/30 uppercase tracking-widest mb-1">{a.code}</div>
                                                            <div className="font-bold text-gray-700">{a.label}</div>
                                                        </td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td className="py-6 font-black text-secondary uppercase">Total Actif</td>
                                                    <td className="py-6 text-right font-mono text-xl font-black text-secondary">
                                                        {data.assets?.reduce((s, a) => s + a.balance, 0).toLocaleString()} <span className="text-xs opacity-40 ml-1">FCFA</span>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    ...
                                    <div>
                                        <div className="flex items-center gap-3 mb-6 border-l-4 border-amber-500 pl-4">
                                            ...
                                            <h3 className="text-lg font-black text-gray-800 uppercase">PASSIF</h3>
                                        </div>
                                        <table className="w-full">
                                            <tbody>
                                                {data.liabilities?.map((l) => (
                                                    <tr key={l.id} className="border-b border-gray-50 group hover:bg-gray-50 transition-colors">
                                                        <td className="py-4">
                                                            <div className="text-xs font-black text-secondary/30 uppercase tracking-widest mb-1">{l.code}</div>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td className="py-6 font-black text-secondary uppercase">Total Passif</td>
                                                    <td className="py-6 text-right font-mono text-xl font-black text-secondary">
                                                        {data.liabilities?.reduce((s, l) => s + l.balance, 0).toLocaleString()} <span className="text-xs opacity-40 ml-1">FCFA</span>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                        ...
                        {reportType === "income_statement" && (
                            <div className="space-y-12">
                                <div className="text-center border-b pb-8">
                                    <h2 className="text-2xl font-black text-secondary uppercase tracking-tight">COMPTE DE RÉSULTAT</h2>
                                    <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] mt-2">Période du {startDate || 'N/A'} au {endDate || 'N/A'}</p>
                                </div>

                                <div className="max-w-4xl mx-auto space-y-10">
                                    {/* PRODUITS */}
                                    <div className="bg-emerald-50/30 rounded-[2rem] p-8 border border-emerald-100">
                                        <h3 className="text-emerald-700 font-black uppercase text-sm tracking-widest mb-6">Produits d'Exploitation</h3>
                                        <table className="w-full">
                                            <tbody>
                                                {data.revenues?.map((r) => (
                                                    <tr key={r.id} className="border-b border-emerald-100/30 last:border-0 group">
                                                        <td className="py-3 font-bold text-gray-700">{r.label}</td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td className="pt-6 font-black text-emerald-800 uppercase italic">Total des Produits</td>
                                    ...
                                    <div className="bg-rose-50/30 rounded-[2rem] p-8 border border-rose-100">
                                        <h3 className="text-rose-700 font-black uppercase text-sm tracking-widest mb-6">Charges d'Exploitation</h3>
                                        <table className="w-full">
                                            <tbody>
                                                {data.expenses?.map((e) => (
                                                    <tr key={e.id} className="border-b border-rose-100/30 last:border-0 group">
                                                        <td className="py-3 font-bold text-gray-700">{e.label}</td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td className="pt-6 font-black text-rose-800 uppercase italic">Total des Charges</td>
                                    ...
                                    {/* RESULTAT NET */}
                                    <div className={`rounded-[2rem] p-10 border-4 border-dashed flex items-center justify-between ${data.net_income >= 0 ? "bg-secondary text-white border-secondary/20" : "bg-red-600 text-white border-red-200"
                                        }`}>
                                        <div>
                                            <div className="flex items-center gap-3">
                                                <Calculator className="opacity-50" size={24} />
                                                <h3 className="text-xl font-black uppercase tracking-tighter">Résultat Net de l'Exercice</h3>
                                            </div>
                                            <p className="text-[10px] font-bold opacity-60 uppercase tracking-widest mt-1">Calculé après compensationProduits/Charges</p>
                                        </div>
                                        <div className="text-right">
                                            <span className="text-5xl font-black tracking-tighter">
                                                {data.net_income?.toLocaleString()}
                                            </span>
                                            <span className="ml-2 text-sm font-bold opacity-50 uppercase">FCFA</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {reportType === "trial_balance" && (
                            <div className="space-y-8">
                                <div className="text-center border-b pb-8">
                                    <h2 className="text-2xl font-black text-secondary uppercase tracking-tight">BALANCE DE VÉRIFICATION</h2>
                                    <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] mt-2">Détails des écritures par compte</p>
                                </div>
...
negou@Negou-Donald:/media/negou/Nouveau nom9/Evolution 4GI 25-26/IHM/v2/fulltang-2026-version$ 
                                                ...
                                                <td className="ft-td">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div className="font-bold text-secondary">
                                                            <span className="text-xs font-black opacity-30 mr-2 uppercase tracking-widest">{a.code}</span>
                                                            {a.label}
                                                        </div>
                                                    </div>
                                                </td>
                                    ...
                                    <tfoot>
                                        <tr className="bg-secondary/5">
                                            <td className="py-6 px-4 font-black text-secondary tracking-widest uppercase italic">Totaux Généraux</td>

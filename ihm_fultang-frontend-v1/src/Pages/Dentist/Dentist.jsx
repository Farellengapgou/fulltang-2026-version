    ...
    const quickActions = [
        {
            ...
            onClick: () => navigate(AppRouterPaths.dentistPatientList)
        },
        {
            icon: Calendar,
            label: "View Appointments List",
            onClick: () => navigate(AppRouterPaths.dentistAppointment)
        },
        {
            icon: FileSpreadsheet,
            label: "View Consultations List",
            onClick: () => navigate(AppRouterPaths.dentistConsultationList)
        }
    ];
        ...
        <CustomDashboard linkList={dentistNavLink} requiredRole={"Dentist"}>
            ...
            <div className="p-6 space-y-6">
                <div className="bg-gradient-to-r from-primary-end to-primary-start rounded-lg p-6 text-white">
                    <h1 className="text-3xl font-bold mb-2">Welcome to the Dentist dashboard</h1>

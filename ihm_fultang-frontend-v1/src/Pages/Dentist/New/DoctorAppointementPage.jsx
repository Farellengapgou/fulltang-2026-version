...
export const AppointmentForm2 = () => {
  ...
  const filteredDentists = dentists.filter((dentist) => dentist.name.toLowerCase().includes(searchDentist.toLowerCase()))
                ...
                <div className="col-span-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      value={searchDentist}
                      onChange={(e) => setSearchDentist(e.target.value)}
                      className="w-full px-4 py-3 pl-12 rounded-lg border border-gray-300 focus:border-primary-end focus:ring-2 focus:ring-primary-start outline-none transition-all"
                    />
                    <FaSearch className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400" size={20} />
                  </div>
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="text-left">
                            ...
                            <p className="text-sm opacity-75">{dentist.speciality}</p>
                          </div>
                        </div>
                      </button>
                    ))}
...
export function DentistAppointementPage() {
  return (

...
class ArticleViewSet(ModelViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"detail": "Impossible de supprimer cet article car il est associé à des mouvements de stock ou d'autres documents (bons, inventaires). Associez-le plutôt au statut inactif si vous souhaitez ne plus l'utiliser."},
